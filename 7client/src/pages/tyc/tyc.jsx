    ...
    <div className={styles.container}>
        ...
        <div className={styles.container2}>
            ...
            <h1 style={{textAlign:"center", color:"white"}}>
                ...
                ESTA PROMO ESTA DE MADRES 7UP® y Schweppes- 2024 <br />
            ...
            <p className={styles.text}>
              3. ESTABLECIMIENTOS PARTICIPANTES: Los Establecimientos Participantes son cualquier comercio localizado en Puerto Rico que venda los “Productos Participantes”.
            </p>
            ...
            <p className={styles.text}>
                ...
                b.  Sin Compra: Método Alterno de Participación-Nada que Comprar para Participar: Para participar sin compra, toda Persona Elegible deberá enviar dentro de un sobre, (franqueo pago) una tarjeta y/o ficha con su nombre, apellidos, dirección de correo electrónico, dirección postal, y  números de teléfonos, acompañada de dos (2) dibujos, en original, hechos a mano, de su propia creación, en blanco y negro, o a color (o facsímil/caracterización razonable) de cualquiera dos (2) diferentes etiquetas de los Productos Schweppes y 7UP®  Participantes,  al siguiente nombre y dirección: “ESTA PROMO ESTÁ DE ​MADRES”,  RosadoToledo&, LLC,  207 Calle del Parque Ste 10 San Juan, PR 00912.
                Previo al envío de los dibujos o facsímiles la persona deberá fotocopiar los mismos y guardar dichas copias. En caso de resultar como Ganador, la persona deberá presentar las copias de los dibujos o facsímiles sometidos para participar al momento de reclamar su Premio.
                Sólo dos (2) facsímiles razonables/dibujos permitidos por sobre con matasellos de correo. Límite de una (1) Participación Gratuita por persona por cada día durante el Periodo del Sorteo.
            ...
            <p className={styles.text}>
            8. PREMIOS: Se sortearán un total de cuatro (4) premios. Entre todas las participaciones válidas, se sortearán los siguientes premios:
                a. Primer Premio (1): Se sorteará un (1) Primer Premio. El Primer Premio consiste de ​
                 $2,000 en efectivo​.
                b. Segundos Premios (2): Se sortearán dos (2) Segundos Premios. Cada Segundo Premio consiste en lo siguiente: $500 en efectivo.
                c. Terceros Premios (3): Se sortearán dos (2) Terceros Premios. Cada Tercer Premio consiste en lo siguiente: un (1) Certificado One Day Spa en Zen Spa valorado en $200 cada uno. 
                d. Cuartos Premios (4): Se sortearán cuatro (4) Gift Cards de Supermercado Ralph´s valorada en $50. Cada premio consiste en una (1) tarjeta de regalo solo redimible en Supermercados Ralph’s.
           ...
           <p className={styles.text}>
           16. ADMINISTRADOR, PREGUNTAS Y RECLAMACIONES: Para preguntas sobre el presente Sorteo o reclamo de premios, favor dirigirse al Administrador del Sorteo: RosadoToledo&, LLC, 207 Calle del Parque Ste 10 San Juan, PR 00912, (787)-3140-5350,  Persona Contacto: Lilliana Correa
